...
import nmap, re, pycurl, json, time, pymysql, logging, smtplib, os, numpy
                                                                                    ...
                                                                                    <table style="border-collapse:collapse;border-spacing:0;padding:0;text-align:left;vertical-align:top;width:100%(html)s">
                                                                                        <tr style="padding:0;text-align:left;vertical-align:top">
                                                                                            <th style="Margin:0;background:#bec2c6;color:#0a0a0a;font-family:Microsoft Yahei;font-size:16px;font-weight:400;line-height:1.3;margin:0;padding:0;text-align:left">
                                                                                                ...
                                                                                                <p style="Margin:0;Margin-bottom:10px;background:#bec2c6;color:#0a0a0a;font-family:Microsoft Yahei;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left">客服：username(xx)</p>
                                                                                                <p style="Margin:0;Margin-bottom:10px;background:#bec2c6;color:#0a0a0a;font-family:Microsoft Yahei;font-size:16px;font-weight:400;line-height:1.3;margin:0;margin-bottom:10px;padding:0;text-align:left">xx@xx.com</p>
                                                                                            </th>
                                                                                        </tr>
                                                                                    </table>
                                                                                </th>
...
def main(ip_list, port_list):
    cpu_num = cpu_count()	#获取主机cpu核数，核数为进程数
    names = locals()
    q = Queue()
...
if __name__ == '__main__':
    ...
    for id in ['000000022737','000000034830','000000032667','000000026895','000000024653',\
        ...
        url = 'http://xxx?buss=%s&page=1' %(id)
        count = request_curl(url)['object']['count']
        url = 'http://xxx?buss=%s&page=1&displayRecord=%s' %(id, count)
        # 合并数组
